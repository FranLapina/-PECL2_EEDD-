...
// el prototipo:
// void func(int&);
void Arbol::InOrden(void (*func)(int&) , pNodo nodo, bool r)
{
   if(r) nodo = raiz;
...
// el prototipo:
// void func(int&);
void Arbol::PreOrden(void (*func)(int&), pNodo nodo, bool r)
{
   if(r) nodo = raiz;
   func(nodo->dato);
...
// el prototipo:
// void func(int&);
void Arbol::PostOrden(void (*func)(int&), pNodo nodo, bool r)
{
   if(r) nodo = raiz;
